-- Migration: Add Global Contacts Database
-- Description: Creates shared global contacts table to reduce API costs across organizations
-- Date: 2024
-- Version: 1.0

-- Run this migration to add the global contacts functionality
-- This enables credit savings by sharing email/contact data across all organizations
...
-- Test the migration by inserting a sample contact
...
SELECT 
    'Global contacts table created successfully' as status,
    COUNT(*) as initial_contacts_count
FROM global_contacts;
